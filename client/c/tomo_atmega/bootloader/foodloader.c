...
/*{{{*/ {
    ...
    // delay_loop_2 donne un delai de 262ms pour un argument de 65635 et un CPU à 1MHz
    // donc on boucle suffisament longtemps pour avoir 3 secondes de pause (l'ATmega est à 12MHz)
    for(i = 0; i < 135; i++) {
        _delay_loop_2(65535);
...
/*{{{*/ {
    ...
    /* at init time, led 0 is on, led 1 is off */
    LED_0_PORT |= (1<<LED_0);
    LED_1_PORT &=~(1<<LED_1);
} /* }}} */

/** toggle led 0 */
static inline void toggle_led_0(void)
/*{{{*/ {
...
/** toggle led 1 */
static inline void toggle_led_1(void)
/*{{{*/ {
...
/** turn off led 0 */
static inline void turn_off_led_0(void)
/*{{{*/ {
...
/** turn off led 1 */
static inline void turn_off_led_1(void)
/*{{{*/ {
...
/** turn on led 0 */
static inline void turn_on_led_0(void)
/*{{{*/ {
...
/** turn on led 1 */
static inline void turn_on_led_1(void)
/*{{{*/ {
